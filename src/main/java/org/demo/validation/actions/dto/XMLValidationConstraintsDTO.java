...
/**
 * Example showing how XML based validation can be used with bean validation.
 *
 */
public class XMLValidationConstraintsDTO implements Serializable
{
    ...
    public XMLValidationConstraintsDTO()
    {
        super();
